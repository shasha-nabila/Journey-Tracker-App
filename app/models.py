...
class User(UserMixin, db.Model):
    ...
    stripe_customer = db.relationship('StripeCustomer', backref='user', uselist=False)
    subscription_id = db.Column(db.Integer, db.ForeignKey('stripe_subscription.id'))
    subscription = db.relationship('StripeSubscription', back_populates='user')
